...
namespace UnitTest_managementTask
{
    ...
    /// Functionalitate: Adaugare test case uri pt verificarea functionalitatii de Creare,Stergere,Modificare Task uri
    /// Add testcases for UniTesting in  UnitTestProjectManagementTask_Database by VaIo
    /// </summary>
    [TestClass]
    public class UnitTestProjectManagementTask_Database
    {
        ...
        */
        ...
        {
            //---------------------------------------------------------------------------------//
            //Verificare daca  inserarea unui task deja existent arunca o exceptie
            //Type-Positive Test Case
            //---------------------------------------------------------------------------------//
            Console.WriteLine("Test_Step_2: Creare Task");
            Task Test_task = new Task(88822, 2, "Task de Testare", "TO DO", "Acesta este primul test case", "6", 4, 3, "-");
